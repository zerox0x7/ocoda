      ...
      <div class="row align-items-center ">
        <div class="col-12 col-lg-6">
          <div class="header__text mb-5">
            <h1 class="header__text__title">خدمات السيو</h1>
            <p class="header__text__desc">
                خدمات السيو لدينا هى أحد أهم جوانب عملنا في مجال التسويق الرقمى، كما أنها أهم مجالات تركيزنا الأساسية، حيث يمكنها أن تدفع نجاحك في فترة زمنية قصيرة.
            </p>
          </div>
    ...
    <div class="row justify-content-md-center">
      <div class="col-lg-8">
        <div class="main-title text-center">
          ...
          الباقات
          <sup class="butterfly_icon"><img src="../../website/assets/img/small_dark_butterfly.svg" alt=""
      ...
      <div class="row g-4">
          ...
          <div class="packages__package">
            <div class="wrap">
                ...
                <img src="../../storage/uploads/pricelists/%d8%a8%d8%a7%d9%82%d8%a9-%d8%a7%d9%84%d9%85%d9%88%d9%82%d8%b9-%d8%a7%d9%84%d8%aa%d8%b9%d8%b1%d9%8a%d9%81%d9%8a_1673446794%20(1)_1675341510.png" alt="باقة انشاء الموقع"
              ...
              <p class="packages__package__desc">
                التحسين الامثل لموقعك
              </p>
              <ul class="packages__package__points">
                                  <li>تحليل كامل لموقعك</li>
                                  <li>تحليل الكلمات الرئيسية</li>
                                  <li>تحسين الصور</li>
                                  <li>Meta Optimization</li>
                                  <li>رفع خريطة الموقع</li>
                                  <li>إنشاء حساب Analytics لمتابعة أداء الموقع</li>
                                  <li>إنشاء حساب search console</li>
                              </ul>
            </div>
            <a href="https://bit.ly/3YtMeYi" class="main-link d-inline-block my-2 w-75 align-self-center">طلب الخدمة</a>
          </div>
        </div>
          ...
          <div class="packages__package">
            <div class="wrap">
                            <div class="packages__package__icon">
                <img src="../../storage/uploads/pricelists/%d8%a8%d8%a7%d9%82%d8%a9-%d8%a7%d9%84%d9%85%d9%88%d9%82%d8%b9-%d8%a7%d9%84%d8%aa%d8%b9%d8%b1%d9%8a%d9%81%d9%8a_1673446794%20(1)_1675341541.png" alt="باقة الأعمال"
                  class="img-fluid lazy" height="100%" width="100%">
              </div>
              <h3 class="packages__package__title">
                باقة الأعمال
              ...
              <ul class="packages__package__points">
                                  <li>تحليل المنافسين وإيجاد نقاط القوة والضعف والإستفادة منها. </li>
                                  <li>إدارة موقعك في محركات البحث.</li>
                                  <li>عمل خطة للكلمات المفتاحية.</li>
                                  <li>إضافة موقعك لمشرفي المواقع ( جوجل Search console – Bing search console )</li>
                                  <li>رفع ال sitemap  الخاص بالموقع. </li>
                                  <li>إضافة جوجل تاج مانجر إلى موقعك.</li>
                                  <li>تهيئة الموقع داخليا. </li>
                                  <li>تهيئة الموقع خارجياَ وإضافة backlinks عالية الجودة ذات صلة بموقعك.</li>
                                  <li>إضافة محتوى لصفحات الأقسام. </li>
                                  <li>عدد الكلمات 6/8 كلمات. </li>
                                  <li>إضافة تحليلات جوجل لموقعك. . </li>
                                  <li>تقديم التقارير شهرياَ بأداء الموقع. </li>
                                  <li>خطة عمل كل 3 شهور.</li>
                              </ul>
            </div>
            <a href="https://bit.ly/3YJqyYj" class="main-link d-inline-block my-2 w-75 align-self-center">طلب الخدمة</a>
          </div>
        </div>
    ...
    <div class="cover__content flout-butterfly">
      <div class="main-title text-center">
        <h2 class="main-title__text text--color mb-2">
          خدمات السيو
          <sup class="butterfly_icon"><img alt="" class="img-fluid lazy" height="100%" width="100%" src="../../website/assets/img/small_dark_butterfly.svg"></sup>
        </h2>
        <h1 dir="rtl" style="text-align:center"><span style="color:#ffffff">حسّن محركات البحث لموقعك على جوجل بسعر يبدأ من 2000 ريال</span></h1>
