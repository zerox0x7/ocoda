      ...
      <div class="row align-items-center ">
        <div class="col-12 col-lg-6">
          <div class="header__text mb-5">
            <h1 class="header__text__title">تصميم مواقع</h1>
            <p class="header__text__desc">
                تقدم لك شركة اوكودا أفضل الحلول والعروض لخدمة تصميم مواقع  فنحن متخصصين في تصميم جميع أنواع المواقع سواء كانت مواقع شركات أو مواقع أشخاص .
            </p>
          </div>
          <div class="d-flex gap-5 align-items-center d-lg-flex d-none">
            ...
            <a href="#" class="second-color watchVideo_btn" data-src="https://player.vimeo.com/video/777767896?h=1d5e4dd24c&amp;amp;badge=0&amp;amp;autopause=0&amp;amp;player_id=0&amp;amp;app_id=58479">
      ...
      <div class="col-lg-8">
        <div class="main-title text-center">
          ...
          <p class="main-title__desc">
            مع اوكودا لخدمات التصميم والتسويق في خدمة السيو،  يمكن لشركتك الاستفادة من حركة مرور متسقة وعالية الجودة.
فتلك العملية تسير في إطار متابعتنا المستمرة أن موقع الويب الخاص بك يتبع أحدث الخوارزميات وأنه يظهر دائمًا في أوائل نتائج البحث.
          </p>
        </div>
      </div>
    </div>
    <div class="package mt-4">
      <div class="row g-4">
          ...
          <div class="packages__package">
            <div class="wrap">
                            <div class="packages__package__icon">
                <img src="../../storage/uploads/pricelists/%d8%a8%d8%a7%d9%82%d8%a9-%d8%a7%d9%84%d9%85%d9%88%d9%82%d8%b9-%d8%a7%d9%84%d8%aa%d8%b9%d8%b1%d9%8a%d9%81%d9%8a_1673446794%20(1)_1675341418.png" alt="باقة الموقع التعريفي"
                  class="img-fluid lazy" height="100%" width="100%">
              </div>
              <h3 class="packages__package__title">
                باقة الموقع التعريفي
              </h3>
              <p class="packages__package__desc">
                مناسبة للشركات الناشئة والمؤسسات الكبرى
              </p>
              <ul class="packages__package__points">
                                  <li>موقع متجاوب مع جميع الأجهزة </li>
                                  <li>استضافة مجانية لمدة عام.</li>
                                  <li>دعم فني لمدة 3 شهور</li>
                                  <li>موقع بلغتين اللغة العربية والانجليزية.</li>
                                  <li>دومين مجاني</li>
                                  <li>انشاء صفحات الموقع كالآتي : الرئيسية - سياسة الاستخدام - الشروط والأحكام - من نحن - اتصل بنا - مشاريعنا)</li>
                              </ul>
            </div>
            <a href="https://bit.ly/3X1qMZm" class="main-link d-inline-block my-2 w-75 align-self-center">طلب الخدمة</a>
          </div>
        </div>
          ...
          <div class="packages__package">
            <div class="wrap">
                            <div class="packages__package__icon">
                <img src="../../storage/uploads/pricelists/%d8%a8%d8%a7%d9%82%d8%a9-%d8%a7%d9%84%d9%85%d9%88%d9%82%d8%b9-%d8%a7%d9%84%d8%aa%d8%b9%d8%b1%d9%8a%d9%81%d9%8a_1673446794%20(1)_1675341489.png" alt="باقة المتجر الالكتروني"
                  class="img-fluid lazy" height="100%" width="100%">
              </div>
              <h3 class="packages__package__title">
                باقة المتجر الالكتروني
              </h3>
              <p class="packages__package__desc">
                لتسهيل عملية البيع والشراء
              </p>
              <ul class="packages__package__points">
                                  <li>نموذج عصري ومتجاوب مع جميع الأجهزة.</li>
                                  <li> متجر بعدد غير محدود من المنتجات. </li>
                                  <li>استضافة مجانية لمدة عام كامل.</li>
                                  <li>دعم فني لمدة 3 شهور. </li>
                                  <li>المتجر بلغتين اللغة العربية والانجليزية. </li>
                                  <li>الربط مع شركة الشحن وبوابة الدفع. </li>
                                  <li>دومين مجاني</li>
                                  <li> رفع 100 منتج ( الوصف – السعر – عدد القطع – صور المنتج) </li>
                                  <li> اضافة أقسام رئيسية للمنتجات وأقسام فرعية</li>
                                  <li>تصنيف المنتجات ( الأكثر مبيعاَ – الأحدث – العروض)</li>
                                  <li>الصفحات ( سياسة الاستخدام – الشروط والأحكام – من نحن – تواصل معنا)</li>
                                  <li>اضافة الجزء الخاص بالتواصل مع خدمة العملاء من خلال الشات أو الواتساب.</li>
                              </ul>
            </div>
            <a href="https://bit.ly/3JK0gRm" class="main-link d-inline-block my-2 w-75 align-self-center">طلب الخدمة</a>
          </div>
        </div>
          ...
          <div class="packages__package">
            <div class="wrap">
                            <div class="packages__package__icon">
                <img src="../../storage/uploads/pricelists/%d8%a8%d8%a7%d9%82%d8%a9-%d8%a7%d9%84%d9%85%d9%88%d9%82%d8%b9-%d8%a7%d9%84%d8%aa%d8%b9%d8%b1%d9%8a%d9%81%d9%8a_1673446794%20(1)_1675341613.png" alt="صفحة الهبوط"
                  class="img-fluid lazy" height="100%" width="100%">
              </div>
              <h3 class="packages__package__title">
                صفحة الهبوط
              ...
              <ul class="packages__package__points">
                                  <li>تصميم احترافي للصفحة</li>
                                  <li>لوجو مجانى</li>
                                  <li>كتابة المحتوى الخاص بالصفحة</li>
                                  <li>دومين مجانى</li>
                                  <li>استضافة لمدة عام مجاناَ </li>
                                  <li>3 إيميلات رسمية </li>
                                  <li>دعم تصفح الهاتف</li>
                                  <li>دعم فني لمدة 3 أشهر.</li>
                              </ul>
            </div>
            <a href="https://bit.ly/3Y8WViW" class="main-link d-inline-block my-2 w-75 align-self-center">طلب الخدمة</a>
          </div>
        </div>
  ...
  <div class="container">
    <div class="cover__content flout-butterfly">
      <div class="main-title text-center">
        ...
        <h1 dir="rtl" style="text-align:center"><span style="color:#ffffff">اطلب موقعك بسعر يبدا من 2000 ريال</span></h1>

<p dir="rtl" style="text-align:center">&nbsp;</p>

<p dir="rtl" style="text-align:center"><a class="main-link main-link--bg" href="https://api.whatsapp.com/send/?phone=%2B966920033141&amp;text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7+%D8%A7%D9%83%D9%88%D8%AF%D8%A7+%D8%A7%D8%B1%D9%8A%D8%AF+%D8%A7%D8%B3%D8%AA%D9%81%D8%B3%D8%B1+%D8%B9%D9%86+%D8%A8%D8%B9%D8%B6+%D8%A7%D9%84%D8%AE%D8%AF%D9%85%D8%A7%D8%AA&amp;type=phone_number&amp;app_absent=0">اطلب الان</a></p>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-8">
      <div class="main-title text-center">
        <h2 class="main-title__text">
          تقنيات مواقع اوكودا
          <sup class="butterfly_icon"><img alt="" class="img-fluid lazy" height="100%" width="100%" src="{{ asset('assets/img/small_dark_butterfly.svg') }} " style=""></sup>
        </h2>
        <p class="main-title__desc">
          تصميم مواقع احترافية مع اوكودا  من أهم الخطوات الأولى التي يجب عليك  اتخاذها عند الاعتماد على التسويق عبر الإنترنت للترويج سواء للخدمات أو المنتجات، كما أنها أيضًا من أكثر الوسائل التسويقية الفعّالة للاستفادة من مزايا التسويق الإلكتروني المتعددة.
  ...
  <div class="my-4">
    <div class="row g-5">
        ...
        <div class="tech__card">
          <img alt="" class="img-fluid lazy w-100" height="100%" width="100%" src="{{ asset('storage/uploads/blogs/Icon-php_1673541946%20(1)_1675334981.svg') }} " style="">
        </div>
      </div>
            <div class="col-6 col-lg-3">
        <div class="tech__card">
          <img alt="" class="img-fluid lazy w-100" height="100%" width="100%" src="{{ asset('storage/uploads/blogs/Icon-react_1673545592_1675335018.svg') }} " style="">
        </div>
      </div>
            <div class="col-6 col-lg-3">
        <div class="tech__card">
          <img alt="" class="img-fluid lazy w-100" height="100%" width="100%" src="{{ asset('storage/uploads/blogs/33_1675335054.svg') }} " style="">
        </div>
      </div>
          </div>
  </div>
